...
class Pump(BaseModel):
    ...
    connectionSize: Optional[float] = Field(
        None,
    ...
    flowResistanceMax: Optional[float] = Field(
        None,
    ...
    flowResistanceMin: Optional[float] = Field(
        None,
        description='Allowable range of frictional resistance against which the fluid is being pumped. Usually measured in Pascals (Pa, N/m2)',
    )
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Pump`')
