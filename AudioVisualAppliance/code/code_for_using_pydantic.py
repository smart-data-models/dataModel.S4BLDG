...
class AudioVisualAppliance(BaseModel):
    ...
    audioVolume: Optional[float] = Field(
        None,
    ...
    mediaSource: Optional[str] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `AudioVisualAppliance`'
    )
