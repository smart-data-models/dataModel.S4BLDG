...
class Interceptor(BaseModel):
    ...
    coverLength: Optional[float] = Field(
        None,
    ...
    coverWidth: Optional[float] = Field(
        None,
    ...
    inletConnectionSize: Optional[float] = Field(
        None,
    ...
    nominalBodyDepth: Optional[float] = Field(
        None,
    ...
    nominalBodyLength: Optional[float] = Field(
        None,
    ...
    nominalBodyWidth: Optional[float] = Field(
        None,
    ...
    outletConnectionSize: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Interceptor`')
    ventilatingPipeSize: Optional[float] = Field(
        None,
