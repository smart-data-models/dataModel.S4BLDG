...
class SpaceHeater(BaseModel):
    ...
    heatTransferDimension: Optional[str] = Field(
        None,
        description='Indicates how heat is transmitted according to the shape of the space heater',
    )
    heatTransferMedium: Optional[str] = Field(
        None, description='Enumeration defining the heat transfer medium if applicable'
    )
    id: Optional[
        Union[
            constr(
    ...
    numberOfPanels: Optional[float] = Field(None, description='Number of panels')
    numberOfSections: Optional[float] = Field(
        None, description='Number of sections used'
    )
    outputCapacity: Optional[float] = Field(
        None,
    ...
    placementType: Optional[str] = Field(
        None, description='Indicates how the device is designed to be placed'
    )
    ...
    temperatureClassification: Optional[str] = Field(
        None,
    ...
    thermalEfficiency: Optional[float] = Field(
        None,
    ...
    thermalMassHeatCapacity: Optional[float] = Field(
        None, description='Product of component mass and specific heat'
    )
    type: Optional[Type6] = Field(None, description='It must be equal to `SpaceHeater`')
