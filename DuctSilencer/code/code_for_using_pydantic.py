...
class DuctSilencer(BaseModel):
    ...
    hasExteriorInsulation: Optional[bool] = Field(
        None,
    ...
    hydraulicDiameter: Optional[float] = Field(
        None, description='Hydraulic diameter. Usually measured in millimeters (mm)'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `DuctSilencer`'
    )
    ...
    workingPressureMin: Optional[float] = Field(
        None,
