...
class AirToAirHeatRecovery(BaseModel):
    ...
    hasDefrost: Optional[bool] = Field(
        None, description='Whether the heat exchanger has defrost function or not'
    )
    ...
    heatTransferTypeEnum: Optional[str] = Field(
        None, description='Type of heat transfer between the two air streams'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `AirToAirHeatRecovery`'
    )
