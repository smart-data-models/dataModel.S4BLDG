...
class Humidifier(BaseModel):
    ...
    internalControl: Optional[str] = Field(
        None, description='Internal modulation control'
    )
    ...
    nominalMoistureGain: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Humidifier`')
