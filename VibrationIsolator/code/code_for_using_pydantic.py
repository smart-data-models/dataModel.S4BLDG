...
class VibrationIsolator(BaseModel):
    ...
    isolatorCompressibility: Optional[float] = Field(
        None, description='The compressibility of the vibration isolator'
    )
    isolatorStaticDeflection: Optional[float] = Field(
        None,
    ...
    supportedWeightMax: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `VibrationIsolator`'
    )
    vibrationTransmissibility: Optional[float] = Field(
        None, description='The vibration transmissibility percentage'
    )
