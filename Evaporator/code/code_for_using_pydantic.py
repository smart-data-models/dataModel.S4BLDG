...
class Evaporator(BaseModel):
    ...
    evaporationCoolant: Optional[str] = Field(
        None, description='The fluid used for the coolant in the evaporator'
    )
    evaporationMediumType: Optional[str] = Field(
        None,
    ...
    externalSurfaceArea: Optional[float] = Field(
        None,
    ...
    internalRefrigerantVolume: Optional[float] = Field(
        None,
        description='Internal volume of evaporator (refrigerant side). Usually measured in cubic metre (m3)',
    )
    internalSurfaceArea: Optional[float] = Field(
        None, description='Internal surface area. Usually measured in square metre (m2)'
    )
    internalWaterVolume: Optional[float] = Field(
        None,
    ...
    nominalHeatTransferArea: Optional[float] = Field(
        None,
    ...
    nominalHeatTransferCoefficient: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Evaporator`')
