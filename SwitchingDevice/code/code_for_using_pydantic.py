...
class SwitchingDevice(BaseModel):
    ...
    isIlluminated: Optional[bool] = Field(
        None,
    ...
    numberOfGangs: Optional[float] = Field(
        None, description='Number of gangs/buttons on this switch'
    )
    owner: Optional[
        List[
            Union[
    ...
    switchFunction: Optional[str] = Field(
        None, description='Indicates types of switches which differs in functionality'
    )
    type: Optional[Type6] = Field(
        None, description='It must be equal to `SwitchingDevice`'
    )
