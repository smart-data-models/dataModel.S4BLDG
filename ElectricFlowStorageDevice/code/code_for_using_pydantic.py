...
class ElectricFlowStorageDevice(BaseModel):
    ...
    nominalSupplyVoltage: Optional[float] = Field(
        None,
        description='The nominal voltage of the supply. Usually measured in Volts (V, W/A)',
    )
    nominalSupplyVoltageMin: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `ElectricFlowStorageDevice`'
    )
