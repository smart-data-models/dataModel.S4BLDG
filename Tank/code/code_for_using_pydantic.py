...
class Tank(BaseModel):
    ...
    nominalDepth: Optional[float] = Field(
        None,
    ...
    nominalLengthOrDiameter: Optional[float] = Field(
        None,
    ...
    operatingWeight: Optional[float] = Field(
        None,
    ...
    secondCurvatureRadius: Optional[float] = Field(
        None,
    ...
    storageType: Optional[str] = Field(
        None, description='Defines the general material category intended to be stored'
    )
    type: Optional[Type6] = Field(None, description='It must be equal to `Tank`')
