...
class Compressor(BaseModel):
    ...
    compressorSpeed: Optional[float] = Field(
        None, description='Compressor speed. Usually measured in cycles/s'
    )
    ...
    hasHotGasBypass: Optional[bool] = Field(
        None,
    ...
    partLoadRatioMax: Optional[float] = Field(
        None, description='Maximum part load ratio as a fraction of nominal capacity'
    )
    partLoadRatioMin: Optional[float] = Field(
        None, description='Minimum part load ratio as a fraction of nominal capacity'
    )
    powerSource: Optional[str] = Field(
        None, description='Type of power driving the compressor'
    )
    refrigerantClass: Optional[str] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Compressor`')
