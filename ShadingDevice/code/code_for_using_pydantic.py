...
class ShadingDevice(BaseModel):
    ...
    mechanicalOperated: Optional[bool] = Field(
        None,
    ...
    roughness: Optional[str] = Field(
        None, description='A measure of the vertical deviations of the surface'
    )
    seeAlso: Optional[Union[List[AnyUrl], AnyUrl]] = Field(
        None, description='list of uri pointing to additional resources about the item'
    )
    shadingDeviceType: Optional[str] = Field(
        None, description='Specifies the type of shading device'
    )
    solarReflectance: Optional[float] = Field(
        None,
    ...
    solarTransmittance: Optional[float] = Field(
        None,
    ...
    thermalTransmittance: Optional[float] = Field(
        None,
        description='Rate at which energy is transmitted through a body. Usually measured in Watts/m2 Kelvin',
    )
    type: Optional[Type6] = Field(
        None, description='It must be equal to `ShadingDevice`'
    )
    visibleLightReflectance: Optional[float] = Field(
        None,
    ...
    visibleLightTransmittance: Optional[float] = Field(
        None,
