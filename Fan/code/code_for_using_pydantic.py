...
class Fan(BaseModel):
    ...
    capacityControlType: Optional[str] = Field(
        None,
    ...
    motorDriveType: Optional[str] = Field(
        None,
    ...
    nominalPowerRate: Optional[float] = Field(
        None, description='Nominal fan power rate.Usually measured in Watts (W, J/s)'
    )
    nominalRotationSpeed: Optional[float] = Field(
        None, description='Nominal fan wheel speed. Usually measured in cycles/s'
    )
    nominalStaticPressure: Optional[float] = Field(
        None,
    ...
    nominalTotalPressure: Optional[float] = Field(
        None,
    ...
    operationMode: Optional[OperationMode] = Field(
        None, description='Operation mode of this fan'
    )
    ...
    operationalRiterial: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Fan`')
