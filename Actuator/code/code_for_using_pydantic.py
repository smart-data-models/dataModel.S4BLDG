...
class Actuator(BaseModel):
    ...
    failPosition: Optional[str] = Field(
        None, description='Specifies the required fail-safe position of the actuator'
    )
    ...
    manualOverride: Optional[bool] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Actuator`')
