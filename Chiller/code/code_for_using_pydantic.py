...
class Chiller(BaseModel):
    ...
    nominalCondensingTemperature: Optional[float] = Field(
        None,
        description='Chiller condensing temperature. Usually measured in degrees Kelvin (K)',
    )
    nominalEfficiency: Optional[float] = Field(
        None, description='Nominal chiller efficiency under nominal conditions. '
    )
    nominalEvaporatingTemmperature: Optional[float] = Field(
        None,
        description='Chiller evaporating temperature.Usually measured in degrees Kelvin (K)',
    )
    nominalHeatRejectionRate: Optional[float] = Field(
        None,
    ...
    nominalPowerConsumption: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Chiller`')
