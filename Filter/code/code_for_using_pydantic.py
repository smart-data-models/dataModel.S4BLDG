...
class Filter(BaseModel):
    ...
    finalResistance: Optional[float] = Field(
        None,
    ...
    initialResistance: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Filter`')
