...
class EvaporativeCooler(BaseModel):
    ...
    heatExchangeArea: Optional[float] = Field(
        None, description='Heat exchange area. Usually measured in square metre (m2)'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `EvaporativeCooler`'
    )
