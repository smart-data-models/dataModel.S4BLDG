...
class ProtectiveDeviceTrippingUnit(BaseModel):
    ...
    limitingTerminalSize: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It must be equal to `ProtectiveDeviceTrippingUnit`'
    )
